...
local get_taglist = function(s)
    ...
    local ghost_icon = gears.color.recolor_image(dot, beautiful.xbackground)

    local dot = gears.surface.load_uncached(
                    gfs.get_configuration_dir() .. "icons/ghosts/dot.png")
    local dot_icon = gears.color.recolor_image(dot, beautiful.xbackground)
    local pacman = gears.surface.load_uncached(
                       gfs.get_configuration_dir() .. "icons/ghosts/pacman.png")
    local pacman_icon = gears.color.recolor_image(dot, beautiful.xbackground)
