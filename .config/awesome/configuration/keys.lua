...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({modkey}, "v", function() awful.spawn("rofi -show drun") end,
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey, "Shift"}, "s",
      ...
      {description = "take screenshot of area", group = "utils"}),
        -- Brightness
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({modkey, }, "c",
              function() awesome.emit_signal("popup::open") end,
              {description = "show stats", group = "awesome"}),
    awful.key({modkey, }, "a",
              function() awesome.emit_signal("popup1::open") end,
              {description = "show center", group = "awesome"}),
    awful.key({modkey, }, "w",
...
client.connect_signal("request::default_keybindings", function()
    awful.keyboard.append_client_keybindings({
        ...
        -- On the fly uselesss gaps change
